...
const injectedCSS = `
  ...
  .login-page-wrapper {
    display: flex;
    min-height: 100vh; /* FIXED: Scroll safe */
    width: 100%;
          ...
          <div className="brand-content">
            ...
            <div>
              ...
              <p className="brand-sub">
                Log in to manage your executive selection and personalized dashboard.
              </p>
            </div>

            <p className="brand-copyright">SECURE ACCESS • 2026 EDITION</p>
          </div>
        </div>
        ...
        <div className="form-side">
          <div className="form-card">
            ...
            <header className="form-header">
              ...
              <p className="form-subtitle">Enter your credentials to access the selection</p>
            </header>
            ...
            <p className="footer-text">
              NEW CLIENT?{" "}
              <span onClick={() => navigate("/register")} className="footer-link">
                CREATE ACCOUNT
              </span>
            </p>
          </div>
